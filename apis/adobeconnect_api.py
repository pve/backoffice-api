...
#adapted from https://github.com/mohsen-hassani/python-connect
# The cookie which hold your login state after a success loign 
BREEZE = ''


def request(action, parameters):
    base_url = os.environ["AC_DOMAIN"] + '/api/xml'
    params = ''
...
#    get_meetings()
    login(os.environ["AC_USER"], os.environ["AC_PW"])
    #meetings = get_meetings_in_folder("") # FOLDER? SCO?
    principals = principal_in_sco("2160861162", "view")
    print(principals)
